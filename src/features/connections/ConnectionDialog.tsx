...
export function ConnectionDialog({
  ...
  return (
    <Modal
      ...
      width={480}
    >
      {/* A real <form>, so Enter from any field submits — the dialog is a
          sequence of text inputs, and every one of them left Enter dead.
          `SaveQueryDialog` already handles Enter; this makes the two agree. */}
      <form
        className="flex flex-col gap-3"
        onSubmit={(e) => {
          e.preventDefault();
          if (busy || !canSubmit || !supported) return;
