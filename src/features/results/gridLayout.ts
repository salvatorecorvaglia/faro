...
/**
 * Width for a column `measureWidths` has no entry for.
 *
 * Reached when the widths map and the result's columns disagree — during the
 * render between a new result arriving and the layout effect re-measuring.
 */
