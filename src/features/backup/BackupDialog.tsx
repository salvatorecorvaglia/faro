          ...
          >
            {shown.length === 0 ? (
              ...
              shown.map((t) => (
                <label
                  key={t.name}
                  className="flex cursor-pointer items-center gap-2 rounded px-1.5 py-0.5 text-xs hover:bg-[var(--bg-inset)]"
                >
                  <input
                    type="checkbox"
                  ...
                  {t.estimatedRows != null && (
                    <span className="text-2xs tabular-nums" style={{ color: 'var(--text-faint)' }}>
      ...
      <div className="flex flex-col gap-3">
        ...
        {info && (
          ...
          >
            ...
            <pre className="selectable mt-1.5 max-h-20 overflow-auto font-mono text-2xs">
