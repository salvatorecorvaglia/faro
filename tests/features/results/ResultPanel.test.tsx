...
describe('ResultPanel', () => {
  ...
  describe('pushdown sort/filter mode (a table tab)', () => {
    // Restoring real timers as the last line of a test only runs when the test
    // passes. One failed assertion above it left fake timers installed for
    // every test after — in this file and, without `isolate`, beyond it.
    afterEach(() => vi.useRealTimers());
